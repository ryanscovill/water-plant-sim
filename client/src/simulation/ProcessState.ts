...
export function createInitialState(): ProcessState {
  return {
    ...
    coagulation: {
      alumDoseRate: 3.0,
      alumDoseSetpoint: 3.0,
      rapidMixerSpeed: 120,
      slowMixerSpeed: 45,
      flocBasinTurbidity: 2.2,
      ...
      pHAdjustDoseRate: 1.0,
      pHAdjustDoseSetpoint: 1.0,
      pHAdjustPumpStatus: { running: true, fault: false, speed: 40, runHours: 1800 },
    },
    sedimentation: {
      clarifierTurbidity: 0.22,
    ...
    disinfection: {
      ...
      chlorineResidualPlant: 0.8,
      chlorineResidualDist: 0.8,
      finishedWaterPH: 7.4,
      clearwellLevel: 4.3,
